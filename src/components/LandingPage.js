...
const LandingPage = () => {
  ...
  const features = [
    ...
    { id: 8, title: "Como surgiu a ideia?", description: "Para desenvolver o aplicativo, identificamos uma problemática recorrente no cotidiano: o trânsito nas cidades. Observando os desafios urbanos, percebemos que essa questão é uma das mais críticas. Assim, nossa empresa nasceu com o propósito de oferecer soluções inteligentes e eficientes para melhorar a mobilidade e reduzir os problemas de tráfego em nossas cidades."},
    { id: 9, title: "Qual o propósito", description: "O propósito do projeto é oferecer uma experiência mais acessível, prática e intuitiva para facilitar a busca por estacionamentos na cidade. Nosso objetivo é transformar a mobilidade urbana ao simplificar o cotidiano dos motoristas, economizando tempo e trazendo comodidade por meio de soluções inteligentes e inovadoras que atendam às demandas da vida moderna."},
  ];
    ...
    return (
      <div className="feature-card">
        <Card 
          ...
          header={<img src={feature.image} alt={feature.title} style={{ width: '100%', height: 'auto' }} />}
        >
        </Card>
      </div>
    );
  ...
  <p className="landing-description">
    ...
    Encontre vagas com eficiência, reserve com antecedência e desfrute de uma mobilidade urbana mais prática e moderna!
      ...
      <footer className="footer">
        <p>&copy; 2023 Smart Park. Todos os direitos reservados.</p>
      </footer>
      </div>
  );
};
